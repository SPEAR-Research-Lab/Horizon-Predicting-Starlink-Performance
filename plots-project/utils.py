...
def filter_filtration_dfs_by_min_measurements(
    ...
    df_filtered_filtered = df_filtered[df_filtered['client_country_code'].isin(valid_countries)]
    ...
    print(f"Records after: df_all={len(df_all_filtered)}, df_filtered={len(df_filtered_filtered)}, df_after={len(df_after_filtered)}")
